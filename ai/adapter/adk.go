...
import (
	...
	"github.com/7as0nch/gocommon/ai"
	"github.com/7as0nch/gocommon/ai/chatmodel"
	"github.com/7as0nch/gocommon/ai/prints"
	"github.com/7as0nch/gocommon/ai/tool"
)
...
func NewEinoAdapter(ctx context.Context, config *ai.AgentConfig, subAgents []ai.Agent) (ai.Agent, error) {
	...
	// NOTE: 业务工具（原 agenttools.GetBussinessTools）与具体项目强相关，
	// 已从通用库抽离；这里默认挂载 GlobalTools（如获取当前时间），
	// 业务侧可通过外部扩展注入自定义工具。
